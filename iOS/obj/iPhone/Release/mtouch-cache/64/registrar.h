...
@class nWorksLeaveApp_iOS_CustomWebViewRenderer;
@class Xamarin_Forms_Platform_iOS_TabbedRenderer;
@class nWorksLeaveApp_iOS_TouchScorePredictTabbedRenderer;
@class nWorksLeaveApp_iOS_CustomNavigationControllerDelegate;
